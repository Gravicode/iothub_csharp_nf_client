...
namespace NFDeviceClientHttpSample.csproj
{
    public class Program
    {
        ...
        private const string BaltimoreCA = @"-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----";
        private const string AddTrustCA = @"-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----";
        private const string GlobalCA = @"-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----";
        public static void Main()
        {
            try
            {
                ...
                var cert = new X509Certificate(BaltimoreCA);
                DeviceClient.CACert = cert;
        ...
        static void OpenWeb()
        {
            ...
            using (var httpWebRequest = (HttpWebRequest)WebRequest.Create(url))
            {
                ...
                //////////////////////////////////////////////////////////////////////
                httpWebRequest.SslProtocols = System.Net.Security.SslProtocols.TLSv1;
